...
<div class="home-container">
  <div>
    <h2 style="font-size: 1.4rem; border-bottom: 1px solid #eee; padding-bottom: 10px; margin-bottom: 10px;">精选项目</h2> <!-- 减少标题底部外边距 -->
    
    <div class="projects-grid">
      <!-- 项目1 -->
      <div class="project-card">
        <div style="display: flex; align-items: center; margin-bottom: 10px;"> <!-- 调整间距 -->
          <i class="fas fa-bookmark" style="color: #6a737d; margin-right: 8px; font-size: 1.1rem;"></i> <!-- 调整图标大小和间距 -->
        ...
        <p style="font-size: 0.95rem; color: #586069; margin-bottom: 12px; line-height: 1.4;"> <!-- 调整字体大小和间距 -->
